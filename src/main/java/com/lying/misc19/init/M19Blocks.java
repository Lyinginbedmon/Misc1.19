...
public class M19Blocks
{
    ...
    public static final RegistryObject<Block> PHANTOM_CUBE = BLOCKS.register("phantom_cube", () -> new PhantomBlock(BlockBehaviour.Properties.of(Material.GLASS).noOcclusion()));
